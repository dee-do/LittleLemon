"""
Django settings for Little_Lemon_Proj project.
...
SECRET_KEY = 'django-insecure-xw%yqi%fjh5hyjtokx3r6qoaq3f)xh4257ag%g_r#%8$wccl^a'
...
ROOT_URLCONF = 'Little_Lemon_Proj.urls'
...
WSGI_APPLICATION = 'Little_Lemon_Proj.wsgi.application'
